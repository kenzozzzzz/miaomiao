<template>
  <div class="register_body">
      <div class="register_email">
        ...
        <button :disabled="disabled" @click="handleToVerigy" >{{verifyInfo}}</button>
      </div>
      <div>
...
.register_body .register_link router-link{ text-decoration: none; margin:0 5px; font-size: 12px; color:#e54847;}
