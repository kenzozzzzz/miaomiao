...
<div class="login_body">
    ...
    <div>
        <input type="text" class="login_text" v-model="verifyImg" placeHolder="验证码"> 
...
.login_body .login_link router-link{ text-decoration: none; margin:0 5px; font-size: 12px; color:#e54847;}
