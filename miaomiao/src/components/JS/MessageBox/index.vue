...
<style>
    .messageBox{width: 200px;height: 120px;border: 1px solid;
    border-radius: 4px;background: white; box-shadow: 3px 3px 3px 3px gray;position: absolute; left: 50%; top: 50%; 
